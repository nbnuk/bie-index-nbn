...
<div>
    ...
    <!-- End Breadcrumb -->
    <h2 class="heading-medium"><g:message code="admin.import.featuredregions.label"/></h2>

    <div class="row">
        <p class="col-md-8 lead"><g:message code="admin.import.featuredregions.lead"/></p>
        <p class="col-md-4 well"><g:message code="admin.import.swap"/></p>
    </div>

    <div>
        <button id="start-import" onclick="javascript:loadInfo('${createLink(controller:'import', action:'importFeaturedRegions')}')" class="btn btn-primary import-button"><g:message code="admin.button.importfeaturedregions"/></button>
    </div>
