...
<div>
    ...
    <div>
        <button id="start-import" onclick="javascript:loadOccCounts()" class="btn btn-primary import-button"><g:message code="admin.button.loadoccurrence"/></button>
    </div>
    <div>
...
<asset:script type="text/javascript">
    function loadOccCounts(){
        loadInfo("${createLink(controller:'placesImport', action:'importOccurrencesPlaces')}?online=" + $('#use-online').is(':checked'));
    }
</asset:script>
</div>
</body>
