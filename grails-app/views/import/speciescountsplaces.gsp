...
<html>
<head>
    <title><g:message code="admin.import.speciescountsplaces.label"/></title>
...
<body>
<div>
    <h2 class="heading-medium"><g:message code="admin.import.speciescountsplaces.label"/></h2>

    <div class="row">
        <p class="col-md-8 lead"><g:message code="admin.import.speciescountsplaces.lead"/></p>
        <p class="col-md-4 well"><g:message code="admin.import.swap"/></p>
    </div>

    <div>
        <button id="start-import" onclick="javascript:loadSpeciesCounts()" class="btn btn-primary import-button"><g:message code="admin.button.loadspeciescountsplaces"/></button>
    </div>
    <div>
